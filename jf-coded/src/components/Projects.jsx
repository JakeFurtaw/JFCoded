        ...
        <div className='project-container'>
            ...
            <div className='projects'>
                <div className='project'>
                    ...
                    To power the chatbot, I'm implementing Retrieval-Augmented Generation (RAG) into the script and using Meta's Llama3 70B model. I have quantized the model to optimize its performance on smaller machines. This combines retrieving pertinent info from the custom dataset with Llama3's fluent text generation abilities. RAG allows the chatbot to efficiently locate relevant data and generate natural, contextual responses tailored to each student's query. <br/><br/>I am also implementing a context window to allow the model to remember past queries and the context received from the database. 
