            ...
            <div className='projects'>
                <div className='project'>
                    ...
                    <p className="project-description"> I am developing a conversational AI assistant specifically for new and existing students at universities. This chatbot will be accessible via website and mobile app, allowing students to interact with it from anywhere to get the information they need. At its core is a custom dataset I've carefully curated with a wide range of relevant topics like course offerings, teacher information, enrollment procedures, campus resources, and more.
                        To power the chatbot, I'm implementing Retrieval-Augmented Generation (RAG) into the script and using Meta's Llama3 70B model. This combines retrieving pertinent info from the custom dataset with Llama3's fluent text generation abilities. The RAG model allows the chatbot to efficiently locate relevant data and generate natural, contextual responses tailored to each student's query. I am also implementing a context window to allow the model to remember past queries and 
                        the context received from the database. This will help if a user wants to ask another question about a previous query to get more information. By deploying it on website and app, I aim to provide an easily accessible resource to enhance the overall student experience, facilitating smoother transitions and navigation through academia. The context tracking will enable fluid multi-turn conversations, allowing students to naturally build on previous topics for a more engaging 
