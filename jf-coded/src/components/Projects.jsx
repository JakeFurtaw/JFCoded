        ...
        <div className='project-container'>
            ...
            <div className='projects'>
                <div className='project'>
                    ...
                    <Link style={{color:'#7da7f5', textDecoration: 'underline'}} to='https://github.com/JakeFurtaw/Llama3-Chatbot'>Project's Github Link</Link>
                    ...
                    To power the chatbot, I'm implementing Retrieval-Augmented Generation (RAG) into the script and using Meta's Llama3 70B model. This combines retrieving pertinent info from the custom dataset with Llama3's fluent text generation abilities. RAG allows the chatbot to efficiently locate relevant data and generate natural, contextual responses tailored to each student's query. <br/><br/>I am also implementing a context window to allow the model to remember past queries and the context received from the database. 
                    This will help if a user wants to ask another question about a previous query to get more information. Additionally, I plan to implement a re-ranker to further improve the relevance of the retrieved information. <br/><br/>I have also quantized the model to optimize its performance on smaller machines. 
