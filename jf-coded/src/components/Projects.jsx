        ...
        <div className='project-container'>
            ...
            <div className='projects'>
                <div className='project'>
                    ...
                    This will help if a user wants to ask another question about a previous query to get more information.<br/><br/> Additionally, I plan to implement a re-ranker to further improve the relevance of the retrieved information. <br/><br/>I have also quantized the model to optimize its performance on smaller machines. 
