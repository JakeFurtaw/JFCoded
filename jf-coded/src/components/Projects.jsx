        ...
        <div className='project-container'>
            ...
            <div className='projects'>
                <div className='project'>
                    <h3>Creating an AI Assistant(Chatbot) using Llama 3</h3>
                    <Link style={{color:'#7da7f5', textDecoration: 'underline'}} to='https://github.com/JakeFurtaw/LangchainRAG-Chatbot'>Project's Github Link</Link>
                    <h4>Project Description</h4>
                    <p className="project-description"> I am developing a conversational AI assistant specifically for new and existing students at universities. This chatbot will be accessible via website and mobile app, allowing students to interact with it from anywhere to get the information they need. <br/><br/>At its core is a custom dataset I've carefully curated with a wide range of relevant topics like course offerings, teacher information, enrollment procedures, campus resources, and more.<br/><br/>
                    To power the chatbot, I'm implementing Retrieval-Augmented Generation (RAG) into the script and using Meta's Llama3 70B model. I have quantized the model to optimize its performance on smaller machines. This combines retrieving pertinent info from the custom dataset with Llama3's fluent text generation abilities.<br/><br/> RAG allows the chatbot to efficiently locate relevant data and generate natural, contextual responses tailored to each student's query. <br/><br/>I am also implementing a context window to allow the model to remember past queries and the context received from the database. 
                    This will help if a user wants to ask another question about a previous query to get more information.<br/><br/> Additionally, I plan to implement a re-ranker to further improve the relevance of the retrieved information.
                    By deploying it on website and app, I aim to provide an easily accessible resource to enhance the overall student experience, facilitating smoother transitions and navigation through academia. The context tracking will enable fluid multi-turn conversations, allowing students to naturally build on previous topics for a more engaging and effective conversational experience.
                    </p>
                </div>
                ...
                <div className='project'>
                    ...
                    To power the chatbot, I'm implementing Retrieval-Augmented Generation (RAG) into the script and using Meta's Llama2 7B model. This combines retrieving pertinent info from the custom dataset with Llama2's fluent text generation abilities. The RAG model allows the chatbot to efficiently locate relevant data and generate natural, contextual responses tailored to each student's query. By deploying it on website and app, I aim to provide an easily accessible resource to enhance the overall student experience, facilitating smoother transitions and navigation through academia. 
                    </p>
                </div>
                ...
                <div className='project'>
                    ...
                    <Link style={{color:'#7da7f5', textDecoration: 'underline'}} to='https://gitlab.com/JakeFurtaw/ASTNN-COSC490'>Project's Gitlab Link</Link>
                    <h4>Project Description</h4>
                ...
                <div className='project'>
                    <h3>Oceans</h3>
                    <Link style={{color:'#7da7f5', textDecoration: 'underline'}} to='https://oceans-prod-v1.vercel.app/'>Link to Oceans Website</Link>
                    <h4>Project Description</h4>
                    <p className="project-description">
